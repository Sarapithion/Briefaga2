...
trait Reponse
{
   ...
   * @return void
   */
  public static function render(string $view, array $data = ['section' => '', 'action' => ''], $StatusCode = 200): void
  {
    if (!empty($data)) {
      extract($data);
    }
   ...
   * @return void
   */
  public static function JsonResponse(null|array $data = null, $StatusCode = 200): void
  {
